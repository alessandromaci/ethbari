            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full">
              ...
              <div className="h-full flex flex-col items-center text-center sm:items-start sm:text-left">
                ...
                <div className="flex-grow flex flex-col items-center sm:items-start">
                  <a href={`mailto:${t('footer.email', 'ethereumbari@gmail.com')}`} className="text-gray-300 hover:text-white underline break-all block mb-3">
                  ...
                  <div className="flex space-x-5">
                    ...
                    <SocialIcon href="https://t.me/+5gcrP-JiHyI3ZTk0" iconName="telegram" />
                  </div>
                </div>
              </div>
