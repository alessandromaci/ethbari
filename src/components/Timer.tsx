      ...
      {isEventOver ? (
        ...
        <>
          <div className="flex flex-col items-center px-2 justify-center h-full">
            <span className="text-lg font-geist md:text-xl text-black font-bold tabular-nums leading-none">
              {formatTime(timeLeft.days)}
            </span>
            <span className="text-[10px] font-geist text-black uppercase tracking-wider leading-none">
