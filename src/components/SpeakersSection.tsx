  ...
  return (
    <section className="w-full bg-white py-20">
      <div className="max-w-9xl mx-auto px-6">
        <div className="gap-4 md:gap-0 flex flex-col items-start md:flex-row md:items-center justify-between mb-12">

            <h2 className="text-4xl text-left md:text-5xl font-black text-black leading-tight font-koho font-medium ">
