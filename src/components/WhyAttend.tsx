...
const benefits: AttendBenefit[] = [
  {
    id: "students",
    titleKey: "whyAttend.students.title",
    titleDefault: "STUDENTI E GIOVANI PROFESSIONISTI",
    descriptionKey: "whyAttend.students.description",
    descriptionDefault:
      "Entrare nel mondo della DeFi, scoprire opportunità di carriera, e avviare il proprio percorso come web3 builder.",
    bgColorClass: "#8CF2A4", // Custom color
    textColorClass: "text-black",
  },
  {
    id: "stakeholders",
    titleKey: "whyAttend.stakeholders.title",
    titleDefault: "STAKEHOLDER",
    descriptionKey: "whyAttend.stakeholders.description",
    descriptionDefault:
      "Contribuire alla nascita di un ecosistema innovativo a Bari, supportando la crescita di una comunità tech focalizzata su blockchain e finanza decentralizzata.",
    bgColorClass: "#B6989133", // Custom color
    textColorClass: "text-black",
  },
  {
    id: "developers",
    titleKey: "whyAttend.developers.title",
    titleDefault: "PER SVILUPPATORI",
    descriptionKey: "whyAttend.developers.description",
    descriptionDefault:
      "Formazione pratica e networking con progetti attivi in DeFi.",
    bgColorClass: "#B6989133", // Custom color
    textColorClass: "text-black",
  },
  {
    id: "everyone",
    titleKey: "whyAttend.everyone.title",
    titleDefault: "PER TUTTI!",
    descriptionKey: "whyAttend.everyone.description",
    descriptionDefault:
      "Partecipare a un evento che unisce economia, tecnologia e impatto sociale in un unico spazio.",
    bgColorClass: "#8CF2A4", // Custom color
    textColorClass: "text-black",
  },
];
...
const BenefitCard: React.FC<{ benefit: AttendBenefit }> = ({ benefit }) => {
  ...
  return (
    <div
      className={`py-6 px-4 lg:px-10 lg:py-10 rounded-3xl shadow-sm ${benefit.textColorClass} flex flex-col min-h-[300px]`}
      style={{ backgroundColor: benefit.bgColorClass }}
    >
      <h3 className="text-2xl lg:text-4xl font-bold mb-3 uppercase tracking-wide font-koho font-bold">
        {t(benefit.titleKey, benefit.titleDefault)}
      </h3>
      <p className="text-base leading-relaxed flex-grow font-geist font-normal">
        {t(benefit.descriptionKey, benefit.descriptionDefault)}
      </p>
    </div>
  );
};
      ...
      <div className="max-w-9xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-end justify-between mb-12 md:mb-16 gap-8 lg:gap-4">
          <div className="text-center lg:text-left w-full lg:w-auto order-2 lg:order-1">
            <h2 className="text-black font-black text-4xl text-center md:text-6xl font-koho font-medium">
        ...
        >
          {benefits.map((benefit) => (
            <div
              key={benefit.id}
              className="w-[85%] sm:w-3/4 md:w-auto flex-shrink-0 snap-center"
            >
